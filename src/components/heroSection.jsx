...
const HeroSection = () => {
  return (
    <div className='relative w-full min-h-[460px] bg-slate-800 overflow-hidden'>
      ...
      {/* Call-to-Action Container rechts */}
      <div className='absolute top-0 right-0 w-[30%] bg-[#3498db] p-5 text-white z-20 h-full flex flex-col justify-center'>
